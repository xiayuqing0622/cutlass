...
using         ElementA    = uint8_t;                                   // Element type for A matrix operand
using         LayoutA     =  cutlass::layout::RowMajor;                                    // Layout type for A matrix operand
constexpr int AlignmentA  =  8;//128 / cutlass::sizeof_bits<ElementA>::value;    // Memory access granularity/alignment of A matrix in units of elements (up to 16 bytes)

// B matrix configuration
using         ElementB    = uint8_t;                                   // Element type for B matrix operand
using         LayoutB     =  cutlass::layout::ColumnMajor;                                    // Layout type for B matrix operand
constexpr int AlignmentB  =  8;    // Memory access granularity/alignment of B matrix in units of elements (up to 16 bytes)

// C matrix configuration
using         ElementC    = int32_t;                            // Element type for C matrix operands
using         LayoutC     =  cutlass::layout::ColumnMajor;                       // Layout type for C matrix operands
constexpr int AlignmentC  =  4;    // Memory access granularity/alignment of C matrix in units of elements (up to 16 bytes)

// D matrix configuration
using         ElementD    = int32_t;                                      // Element type for D matrix operands
using         LayoutD     =  cutlass::layout::ColumnMajor;                                        // Layout type  D matrix operands
constexpr int AlignmentD  =  4;                                     // Memory access granularity/alignment of D matrix in units of elements (up to 16 bytes)


// Core kernel configurations
using ElementAccumulator  = int32_t;                                          // Element type for internal accumulation
using ElementEpilogue = int32_t;                                          // Element type for internal computation
...
using KernelScheduleType =  cutlass::gemm::KernelCpAsyncWarpSpecialized;
