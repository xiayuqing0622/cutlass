...
constexpr int AlignmentA  =  2;//128 / cutlass::sizeof_bits<ElementA>::value;    // Memory access granularity/alignment of A matrix in units of elements (up to 16 bytes)

// B matrix configuration
using         ElementB    = cutlass::half_t;                                   // Element type for B matrix operand
using         LayoutB     =  cutlass::layout::RowMajor;                                    // Layout type for B matrix operand
constexpr int AlignmentB  =  2;    // Memory access granularity/alignment of B matrix in units of elements (up to 16 bytes)
...
constexpr int AlignmentC  =  8;    // Memory access granularity/alignment of C matrix in units of elements (up to 16 bytes)
...
constexpr int AlignmentD  =  8;                                     // Memory access granularity/alignment of D matrix in units of elements (up to 16 bytes)


// Core kernel configurations
using ElementAccumulator  = cutlass::half_t;                                          // Element type for internal accumulation
using ElementEpilogue = cutlass::half_t;                                          // Element type for internal computation
...
using TileShape           = cute::Shape<cute::_128, cute::_128, cute::_64>;                           // Threadblock-level tile size
using TileShapeMain       = cute::Shape<cute::_128, cute::_128, cute::_64>;                           // Threadblock-level tile size
