...
using         ElementC    = int8_t;                            // Element type for C matrix operands
using         LayoutC     =  cutlass::layout::ColumnMajor;                       // Layout type for C matrix operands
constexpr int AlignmentC  =  16;    // Memory access granularity/alignment of C matrix in units of elements (up to 16 bytes)

// D matrix configuration
using         ElementD    = uint8_t;                                      // Element type for D matrix operands
using         LayoutD     =  cutlass::layout::ColumnMajor;                                        // Layout type  D matrix operands
constexpr int AlignmentD  =  16;                                     // Memory access granularity/alignment of D matrix in units of elements (up to 16 bytes)
